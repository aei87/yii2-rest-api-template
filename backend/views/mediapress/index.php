<div class="container inner">
    ...
    <div class="col-md-6 mb-4">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="response_active" data-toggle="tab" href="#response_body" role="tab" aria-controls="profile" aria-expanded="false"><i class="icon-options-vertical"></i> Response &nbsp;<span class="badge badge-pill badge-danger">info</span></a>
            </li>
            <li class="nav-item">
